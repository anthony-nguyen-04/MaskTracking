...
def closestFace(locs, preds):

    (closestFaceBox, closestFacePred) = ((0,0,0,0), (0,0))
    ...
    for (box, pred) in zip(locs, preds):
        ...
        if ( (xLength * yLength) > ( (closestFaceBox[2] - closestFaceBox[0]) * (closestFaceBox[3] - closestFaceBox[1]) ) ):
            closestFaceBox = box
            closestFacePred = pred

    return (closestFaceBox, closestFacePred)
...
while True:
    ...
    (closestFaceBox, closestFacePred) = closestFace(locs, preds)
